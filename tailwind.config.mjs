...
const theme = require('./src/shared/config/theme.ts');
const font_base = Number(theme.fonts.font_size.base);
...
export default {
    ...
    theme: {
        ...
        extend: {
            colors: {
                text: theme.colors.text_color.default,
                ...
                'theme-light': theme.colors.theme_color.theme_light,
            },
            fontSize: {
                base: font_base + 'px',
                h1: h1 + 'rem',
    ...
    plugins: [require('@tailwindcss/typography'), require('@tailwindcss/forms'), require('tailwind-bootstrap-grid')({ generateContainer: false })],
};
